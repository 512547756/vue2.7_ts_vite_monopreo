...
export function createBarOpts(colors: Colors[], categorys?: string[], direction = BarDirectionEnum.Vertical): any {
    return {
        grid: {
            top: 30,
            bottom: 30,
...
function initColorOpts(colors: Colors[], direction: BarDirectionEnum) {
